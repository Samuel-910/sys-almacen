        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/IVANMAMANI2003/sys-almacen.git'
                }
            }
        }
        stage('Build') {
